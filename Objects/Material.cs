...
namespace RayTracing
{
    ...
    class Material
    {
        ...
        public double krefractivity;
        
        public double transparency;
        public double reflectivity;
        
        public Material(double shininess, double kspecular, double kdiffuse, double kambient, double transparency, double reflectivity, double krefractivity = 1.5)
        {
            ...
            this.krefractivity = krefractivity;
        }
    }
}
