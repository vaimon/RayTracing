...
namespace RayTracing
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            sphereOnGround = new Sphere(new Point(5, -7, 15), 3, Color.DarkSalmon,
                new Material(70, 0.1, 0.85, 0.05, 0, 0));
            cube = new Cube(new Point(-5, -7, 16), 2, Color.DarkRed, new Material(40, 0.25, 0.7, 0.05, 0, 0));
            //cube = new Cube(new Point(5, 7, 16), 4, Color.DarkRed, new Material(40, 0.25, 0.7, 0.05, 0, 0,1.2));
