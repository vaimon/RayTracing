...
namespace RayTracing
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            rayTracing = new RayTracing(new LightSource(new Point(0,15,14),2), new Room(new Point(0,0,14),30, Color.Gray));
            rayTracing.renderProgress += updateProgress;
            rayTracing.addShape(new Sphere(new Point(0, -10, 16), 2, Color.DarkSalmon));
